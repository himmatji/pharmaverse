...
const PharmD = () => {
  ...
  const fetchNotes = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/notes?course=Pharm.D");
      setNotes(res.data);
  ...
  const fetchPremiumVideos = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/videos?course=Pharm.D");
  ...
  const fetchFreeVideos = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/free-videos?course=Pharm.D");
      const freeOnly = res.data.filter(video => video.isPremium === false);
      setFreeVideos(freeOnly);
    } catch (error) { 
      console.log(error);
      try {
        const allRes = await axios.get("https://api.pharmaverse.co.in/api/admin/public/videos?course=Pharm.D");
  ...
  const fetchPaidPDFs = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/paid-pdfs?course=Pharm.D");
  ...
  const fetchPapers = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/papers?course=Pharm.D");
