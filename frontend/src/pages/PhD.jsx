...
const PhD = () => {
  ...
  // ========== COMING SOON SECTIONS (NEW CARDS) ==========
  const comingSoonSections = [
    {
      ...
      description: "Comprehensive research notes & study material curated for PhD scholars.",
    },
    {
      ...
      subtitle: "Quick Revision Series",
      description: "Fast-track exam preparation with key topics, shortcuts & important questions.",
    },
    {
      id: "pyqs",
      icon: Brain,
      ...
      description: "Previous year question papers with solutions & pattern analysis for PhD exams.",
    },
    {
      id: "research-project",
      icon: FlaskConical,
      ...
      subtitle: "Guides & Methodology",
      description: "Research methodology, thesis guidance, project work & publication support.",
    },
  ];
