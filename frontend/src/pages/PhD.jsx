...
const PhD = () => {
  ...
  const fetchNotes = async () => {
    try {
      const res = await axios.get(`${API_BASE}/api/admin/public/notes?course=PhD`);
      setNotes(res.data);
  ...
  const fetchPremiumVideos = async () => {
    try {
      const res = await axios.get(`${API_BASE}/api/admin/public/videos?course=PhD`);
  ...
  const fetchFreeVideos = async () => {
    try {
      const res = await axios.get(`${API_BASE}/api/admin/public/free-videos?course=PhD`);
      ...
      try {
        const allRes = await axios.get(`${API_BASE}/api/admin/public/videos?course=PhD`);
  ...
  const fetchPaidPDFs = async () => {
    try {
      const res = await axios.get(`${API_BASE}/api/admin/public/paid-pdfs?course=PhD`);
  ...
  const fetchPapers = async () => {
    try {
      const res = await axios.get(`${API_BASE}/api/admin/public/papers?course=PhD`);
  ...
  const fetchPremiumPrice = async () => {
    try {
      ...
      // Try PhD first, fallback to B.Pharm
      const course = data["PhD"] || data["B.Pharm"];
