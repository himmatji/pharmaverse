...
const PhD = () => {
  ...
  const fetchNotes = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/notes?course=PhD");
      setNotes(res.data);
  ...
  const fetchPremiumVideos = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/videos?course=PhD");
  ...
  const fetchFreeVideos = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/free-videos?course=PhD");
      const freeOnly = res.data.filter(video => video.isPremium === false);
      setFreeVideos(freeOnly);
    } catch (error) { 
      console.log(error);
      try {
        const allRes = await axios.get("https://api.pharmaverse.co.in/api/admin/public/videos?course=PhD");
  ...
  const fetchPaidPDFs = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/paid-pdfs?course=PhD");
  ...
  const fetchPapers = async () => {
    try {
      const res = await axios.get("https://api.pharmaverse.co.in/api/admin/public/papers?course=PhD");
        ...
        <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2">
          ...
          <div className="p-5 pt-7">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-5 line-clamp-2">
              {item.description || "Comprehensive research material designed for PhD scholars."}
            </p>
      ...
      >
        ...
        <div className="relative bg-white rounded-2xl overflow-hidden shadow-lg group-hover:shadow-2xl transition-all duration-500 group-hover:-translate-y-2">
          ...
          <div className="p-5 pt-7">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-5 line-clamp-2">
              {item.description || "Premium research material for PhD excellence."}
            </p>
          ...
          <div className="relative z-20 flex items-center h-full px-4 sm:px-6 md:px-20">
            <div className="max-w-[520px]">
              <h1 className="text-white text-3xl sm:text-4xl md:text-7xl font-extrabold leading-tight mb-3 sm:mb-5">
                Doctor of<br /><span className="text-sky-400">Philosophy</span>
              </h1>
