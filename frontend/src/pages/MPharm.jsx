...
const branches = [
  { id: "Pharmaceutics", label: "Pharmaceutics", icon: FlaskRound, gradient: "from-blue-600 via-indigo-600 to-purple-600", bgGradient: "from-blue-50 via-indigo-50 to-purple-50", glowColor: "rgba(99, 102, 241, 0.3)", description: "Drug delivery, formulation & modern pharmaceutics", stats: "4 Semesters", badge: "💊 Core" },
  { id: "Pharmacology", label: "Pharmacology", icon: HeartPulse, gradient: "from-rose-500 via-pink-500 to-purple-500", bgGradient: "from-rose-50 via-pink-50 to-purple-50", glowColor: "rgba(244, 63, 94, 0.3)", description: "Drug action, screening & molecular pharmacology", stats: "4 Semesters", badge: "🔬 Research" },
  { id: "Pharmaceutical Chemistry", label: "Pharmaceutical Chemistry", icon: Beaker, gradient: "from-emerald-500 via-teal-500 to-cyan-500", bgGradient: "from-emerald-50 via-teal-50 to-cyan-50", glowColor: "rgba(16, 185, 129, 0.3)", description: "Organic, medicinal & analytical chemistry", stats: "4 Semesters", badge: "⚗️ Chemistry" },
  { id: "Pharmacognosy", label: "Pharmacognosy", icon: Leaf, gradient: "from-amber-500 via-orange-500 to-yellow-500", bgGradient: "from-amber-50 via-orange-50 to-yellow-50", glowColor: "rgba(251, 146, 60, 0.3)", description: "Natural products, phytochemistry & herbal drugs", stats: "4 Semesters", badge: "🌿 Herbal" },
  { id: "Regulatory Affairs", label: "Regulatory Affairs", icon: Shield, gradient: "from-violet-500 via-purple-500 to-fuchsia-500", bgGradient: "from-violet-50 via-purple-50 to-fuchsia-50", glowColor: "rgba(139, 92, 246, 0.3)", description: "Drug regulations, documentation & compliance", stats: "4 Semesters", badge: "📋 Regulatory" },
];
...
const categories = [
  ...
  { id: "Exam Crash Course", label: "Exam Crash Course", icon: Rocket, gradient: "from-orange-500 via-amber-500 to-yellow-500", bgGradient: "from-orange-50 via-amber-50 to-yellow-50", glowColor: "rgba(251, 146, 60, 0.3)", description: "Click below to view Exam Crash Course", stats: "4 Semesters", badge: "🔥 Crash" },
...
const MPHARM_SUBJECTS = {
  "Pharmaceutical Chemistry": {
    1: ["Modern Pharmaceutical Analytical Techniques", "Advanced Organic Chemistry-I", "Advanced Medicinal Chemistry", "Chemistry of Natural Products"],
    2: ["Advanced Spectral Analysis", "Advanced Organic Chemistry-II", "Computer Aided Drug Design", "Pharmaceutical Process Chemistry"],
    3: ["Research Methodology & Biostatistics", "Research Work"],
    4: ["Research Work"],
  },
  Pharmacognosy: {
    1: ["Modern Pharmaceutical Analytical Techniques", "Advanced Pharmacognosy-I", "Phytochemistry", "Industrial Pharmacognostical Technology"],
    2: ["Medicinal Biotechnology", "Advanced Pharmacognosy-II", "Indian System of Medicine", "Herbal Cosmetics"],
    3: ["Research Methodology & Biostatistics", "Research Work"],
    4: ["Research Work"],
  },
  Pharmaceutics: {
    1: ["Modern Pharmaceutical Analytical Techniques", "Drug Delivery System", "Modern Pharmaceutics", "Regulatory Affair"],
    2: ["Molecular Pharmaceutics (Nano Tech and Targeted DDS)", "Advanced Biopharmaceutics & Pharmacokinetics", "Computer Aided Drug Delivery System", "Cosmetic and Cosmeceuticals"],
    3: ["Research Methodology & Biostatistics", "Research Work"],
    4: ["Research Work"],
  },
  Pharmacology: {
    1: ["Modern Pharmaceutical Analytical Techniques", "Advanced Pharmacology-I", "Pharmacological and Toxicological Screening Methods-I", "Cellular and Molecular Pharmacology"],
    2: ["Advanced Pharmacology-II", "Pharmacological and Toxicological Screening Methods-II", "Principles of Drug Discovery", "Experimental Pharmacology Practical-II"],
    3: ["Research Methodology & Biostatistics", "Research Work"],
    4: ["Research Work"],
  },
  "Regulatory Affairs": {
    1: ["Good Regulatory Practices", "Documentation and Regulatory Writing", "Clinical Research Regulations", "Regulations and Legislation for Drugs & Cosmetics, Medical Devices, Biologicals & Herbals, and Food & Nutraceuticals in India and Intellectual Property Rights"],
    2: ["Regulatory Aspects of Drugs & Cosmetics", "Regulatory Aspects of Herbal & Biologicals", "Regulatory Aspects of Medical Devices", "Regulatory Aspects of Food & Nutraceuticals"],
    3: ["Research Methodology & Biostatistics", "Research Work"],
    4: ["Research Work"],
  },
};
...
const MPharm = () => {
  ...
  const fetchUnitContent = async () => {
    ...
    const cacheKey = ["M.Pharm", selectedBranch, selectedCategory, selectedSemester, selectedSubject].join("||");
    ...
    try {
      ...
      const rawContent = getRawContent(res?.data)
        ...
        .filter((item) => {
          ...
          const semesterMatches = itemSemester == null || String(itemSemester).trim() === String(selectedSemester).trim();
          ...
          const courseMatches = item?.course == null || String(item.course).trim().toLowerCase() === "m.pharm";
          const branchMatches = itemBranch == null || String(itemBranch).trim().toLowerCase() === String(selectedBranch).trim().toLowerCase();

          return courseMatches && semesterMatches && subjectMatches && categoryMatches && branchMatches;
        });
  ...
  const handleSubjectClick = (subject) => {
    if (isResearchWork(subject)) {
      ...
      if (!win) toast.error("Please allow popups to open Gmail");
      else toast.success("Gmail opened — get guidance & support!");
      return;
    }
  ...
  useEffect(() => {
    ...
    styleSheet.textContent = `
      ...
      .branch-card-1 { animation-delay: 0.1s; } .branch-card-2 { animation-delay: 0.2s; } .branch-card-3 { animation-delay: 0.3s; }
      .branch-card-4 { animation-delay: 0.4s; } .branch-card-5 { animation-delay: 0.5s; }
      ...
      <div className="animate-slide-up">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-sky-100 to-blue-100 mb-4 animate-float-text">
            ...
            <span className="text-xs font-['Inter'] font-bold text-sky-700 tracking-wider uppercase">M.Pharm</span>
            <Sparkles className="text-sky-600" size={16} />
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-['Space_Grotesk'] font-extrabold text-gray-900 leading-tight">
            Select Your <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">Branch</span>
          </h1>
          ...
          <p className="text-gray-500 text-base mt-4 font-['Inter'] font-medium">Choose your specialization to continue</p>
        </div>
          ...
          {branches.map((branch, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`relative bg-gradient-to-br ${branch.bgGradient} rounded-3xl p-7 sm:p-8 transition-all duration-500 group-hover:-translate-y-4 group-hover:shadow-2xl border-2 border-white/50 backdrop-blur-sm overflow-hidden h-full`}>
                  ...
                  <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${branch.gradient} flex items-center justify-center mb-5 shadow-2xl group-hover:scale-110 transition-all duration-500 animate-float-medium relative z-10`}>
                    <Icon className="text-white" size={34} />
                  </div>

                  <div className="absolute top-4 right-4 z-10">
                    <span className={`text-[10px] font-['Inter'] font-bold px-3 py-1 rounded-full bg-gradient-to-r ${branch.gradient} text-white shadow-lg animate-pulse`}>
                      {branch.badge}
                    </span>
                  </div>

                  <div className="relative z-10">
                    <h3 className="text-xl sm:text-2xl font-['Space_Grotesk'] font-extrabold text-gray-800 mb-2">{branch.label}</h3>
                    <p className="text-sm font-['Inter'] text-gray-600 leading-relaxed mb-3">{branch.description}</p>
                  ...
                  <div className={`absolute bottom-0 left-0 right-0 h-1.5 bg-gradient-to-r ${branch.gradient} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left rounded-b-3xl`}></div>
                </div>
              </div>
            );
          })}
  ...
  const renderCategoryStep = () => {
    ...
    const branchGradient = branches.find((b) => b.id === selectedBranch)?.gradient || "from-purple-500 to-pink-500";
      ...
      <div className="animate-slide-up">
        <div className="flex items-center gap-4 mb-8 flex-wrap">
          ...
          <div className="flex items-center gap-3 glass-effect rounded-2xl px-5 py-3 shadow-lg border border-white/50">
            <div className={`w-10 h-10 rounded-xl bg-gradient-to-r ${branchGradient} flex items-center justify-center shadow-md animate-pulse`}>
              <Icon className="text-white" size={18} />
            </div>
            <span className="font-['Space_Grotesk'] font-bold text-gray-800 text-lg">{branchLabel}</span>
          </div>
        </div>
              ...
              >
                ...
                <div
                  className={`relative rounded-2xl p-5 sm:p-6 text-center transition-all duration-500 overflow-hidden premium-card ${delayClass}
                    ${isAvailable ? `bg-gradient-to-br ${colors.bg} border-2 ${colors.border} shadow-xl ${colors.shadow}` : "bg-gray-100 border-2 border-gray-200"}`}
                  style={isAvailable ? { boxShadow: `0 8px 32px ${colors.glow}, inset 0 1px 0 rgba(255,255,255,0.9), inset 0 -1px 0 rgba(0,0,0,0.05)` } : undefined}
                >
                  {isAvailable && (
                    <>
                      <div
                  ...
                  <div className="relative z-10">
                    <div
                      className={`text-4xl sm:text-5xl font-['Space_Grotesk'] font-extrabold ${
                        isAvailable ? `gradient-text bg-gradient-to-r ${colors.gradient} bg-clip-text text-transparent` : "text-gray-400"
                      } leading-none number-glow`}
                    >
                      {sem}
                    </div>
                    <div className={`text-[10px] sm:text-xs font-['Inter'] font-semibold uppercase tracking-widest mt-1.5 ${isAvailable ? "text-gray-500" : "text-gray-400"}`}>
                      Semester
                    </div>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3 min-w-0">
                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${iconData.color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300 shadow-md`}>
                          {research ? <Mail className={`${iconData.textColor}`} size={22} /> : <SIcon className={`${iconData.textColor}`} size={22} />}
                        </div>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <div className={`w-8 h-8 rounded-full bg-gradient-to-r ${colors.gradient} opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center shadow-lg transform group-hover:scale-110`}>
                        {research ? <Send className="text-white" size={16} /> : <ArrowRight className="text-white" size={16} />}
                      </div>
                    </div>
                  </div>
          ...
          <div className="relative z-20 flex items-end h-full px-4 sm:px-8 md:px-16 lg:px-24 pb-10 sm:pb-12 md:pb-14 lg:pb-16">
            <div className="max-w-2xl animate-slide-up">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 mb-4 animate-float-text">
                ...
                <span className="text-xs font-['Inter'] font-semibold text-blue-300 tracking-widest uppercase">M.Pharm Program</span>
